            ...
            <form method="POST" action="{{ route('admin.users.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <select id="app_source" 
                        ...
                        <option value="ios" {{ old('app_source') == 'ios' ? 'selected' : '' }}>iOS App</option>
                        <option value="android" {{ old('app_source') == 'android' ? 'selected' : '' }}>Android App</option>
                        <option value="web" {{ old('app_source') == 'web' ? 'selected' : '' }}>Web App</option>
                        <option value="api" {{ old('app_source') == 'api' ? 'selected' : '' }}>API</option>
                    </select>
                    @error('app_source')
                        <p class="text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
