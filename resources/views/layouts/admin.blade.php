            ...
            <div class="flex min-h-0 flex-1 flex-col gap-2 overflow-auto p-2">
                ...
                <div class="relative flex w-full min-w-0 flex-col p-2">
                    ...
                    <ul class="flex w-full min-w-0 flex-col gap-1">
                        ...
                        <li class="group/menu-item relative">
                            <a href="/admin/database" class="sidebar-item flex w-full items-center cursor-pointer gap-2 overflow-hidden rounded-md p-2 text-left transition-all hover:bg-gray-700 h-8 text-sm {{ request()->is('admin/database*') ? 'active bg-gray-700' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <li class="group/menu-item relative">
                            <a href="/settings" class="sidebar-item flex w-full items-center cursor-pointer gap-2 overflow-hidden rounded-md p-2 text-left transition-all hover:bg-gray-700 h-8 text-sm {{ request()->is('settings') ? 'active bg-gray-700' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
