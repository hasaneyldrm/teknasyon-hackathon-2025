                ...
                <div class="relative flex w-full min-w-0 flex-col p-2">
                    ...
                    <ul class="flex w-full min-w-0 flex-col gap-1">
                        <li class="group/menu-item relative">
                            <a href="/" class="sidebar-item flex w-full items-center cursor-pointer gap-2 overflow-hidden rounded-md p-2 text-left transition-all hover:bg-gray-700 h-8 text-sm {{ request()->is('/') ? 'active bg-gray-700' : '' }}">
