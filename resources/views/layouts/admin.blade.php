...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('ggpt.png') }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('ggpt.png') }}">
        ...
        <div class="w-64 sidebar flex flex-col h-screen fixed left-0 top-0 z-40">
            ...
            <div class="p-6 border-b border-gray-700">
                <h1 class="text-xl font-bold text-white flex items-center" style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">
                    <img src="{{ asset('ggpt.png') }}" alt="GlobalGPT" class="w-14 mr-3 rounded-lg" style="height: 59.8px;">
                    GlobalGPT
                </h1>
            </div>
            ...
            <div class="flex min-h-0 flex-1 flex-col gap-2 overflow-auto p-2">
                ...
                <div class="relative flex w-full min-w-0 flex-col p-2">
                    ...
                    <ul class="flex w-full min-w-0 flex-col gap-1">
                        ...
                        <li class="group/menu-item relative">
                            <a href="/admin/docs" class="sidebar-item flex w-full items-center cursor-pointer gap-2 overflow-hidden rounded-md p-2 text-left transition-all hover:bg-gray-700 h-8 text-sm {{ request()->is('admin/docs') ? 'active bg-gray-700' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
